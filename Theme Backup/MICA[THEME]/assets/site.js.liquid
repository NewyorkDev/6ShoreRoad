...
HeaderView = (function(superClass) {
  ...
  HeaderView.prototype._validate = function() {
    ...
    if (this.mainHeaderWrap.attr('data-header-format') === 'minimal') {
      this.body.addClass('main-header-slim');
    } else {
      this.body.removeClass('main-header-slim');
    }
    if (this.mainHeaderWrap.attr('data-header-alignment') === 'true') {
      this.body.addClass('header-centered');
    } else {
      this.body.removeClass('header-centered');
    }
    ...
    this.window.resize((function(_this) {
      return function() {
        _this.resize();
        if (_this.mainHeaderWrap.attr('data-header-alignment') !== 'true') {
...
NavigationView = (function(superClass) {
  ...
  NavigationView.prototype._validate = function() {
    ...
    this.MegaNavigationView = new MegaNavigationView({
      el: this.$megaNav
    });
  ...
  NavigationView.prototype.prepareRemove = function() {
    ...
    return this.MegaNavigationView.remove();
  };
  ...
  NavigationView.prototype.establishTierDirection = function(e) {
    ...
    this.$megaNav.trigger('dismissMegaNav');
  ...
  NavigationView.prototype.toggleMegaNav = function(e) {
    ...
    this.$megaNav.trigger('toggleMegaNav');
    return false;
  };
...
ProductView = (function(superClass) {
  ...
  ProductView.prototype.handleErrors = function(error) {
    var max, message, submitButton, target, variant, variantID;
    ...
    submitButton.val(error.message);
    return setTimeout((function(_this) {
      return function() {
